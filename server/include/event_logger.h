...
namespace EventLogger {
    ...
    PixelPaintedEvent create_pixel_painted_event(const std::string& timestamp, const std::string& username, int index, const std::string& color); // 创建
    ...
    void append_event_to_log(const std::string& filename, const PixelPaintedEvent& event); // 将事件追加到日志文件
